...
$resultado  = mysql_query($consulta_Aroma , $conecion);
  ...
  // Descomponemos nuestro Array en Objetos
                              ...
                              $datos [$cont]->colorPiel= $fila['piel'];
                              $datos [$cont]->caderas= $fila['caderas'];
                              ...
                              $datos [$cont]->conMujer= $fila['conMujeres'];
                              $datos [$cont]->conParejas= $fila['conParejas'];
                              $datos [$cont]->trioMHM= $fila['conMujeres'];
                              $datos [$cont]->trioHMH= $fila['conMujeres'];
                              $datos [$cont]->desSoltero= $fila['despedidaSoltero'];
                              $datos [$cont]->baile= $fila['baileErotico'];
                              $datos [$cont]->jugetes= $fila['jugetes'];
                              $datos [$cont]->lluviaDorada= $fila['lluviaDorada'];
                              $datos [$cont]->ciudad= $fila['ciudad'];
                              $datos [$cont]->hora1= $fila['hora1'];
                              $datos [$cont]->hora2= $fila['hora2'];
