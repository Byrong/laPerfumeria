...
CREATE TABLE `Aroma` (
  ...
  `cabello` varchar(10) DEFAULT NULL,
  `busto` varchar(30) DEFAULT NULL,
  `ojos` varchar(10) DEFAULT NULL,
  `piel` varchar(10) DEFAULT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `Aroma` VALUES ('1', 'lau@hotmail.com', 'Laura', 'Vanilla Sky', 'M', '22', '1', 'Negro', '32', 'Cafe', 'Morena', '67', 'Español', 'No', 'rojo1.jpg', 'rojo2.jpg', 'rojo3.jpg', 'rojo4.jpg', '2015-06-09'), ('2', 'estefan@gmail.com', 'Estefan', 'Frutos Rojos', 'M', '24', '170', 'Rubio', '27', 'Miel', 'Blanca', '60', 'Español / English', 'No', null, null, null, null, '2015-06-09');
COMMIT;
...
CREATE TABLE `Servicio` (
  ...
  `sexoOral` varchar(2) DEFAULT NULL,
  `sexoOral2` varchar(2) DEFAULT NULL,
  `sexoAnal` varchar(2) DEFAULT NULL,
  `conMujeres` varchar(2) DEFAULT NULL,
  `conParejas` varchar(2) DEFAULT NULL,
  `trioHMH` varchar(2) DEFAULT NULL,
  `trioMHM` varchar(2) DEFAULT NULL,
  `jugetes` varchar(2) DEFAULT NULL,
  `despedidaSoltero` varchar(2) DEFAULT NULL,
  `baileErotico` varchar(2) DEFAULT NULL,
  `lluviaDorada` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idAroma` (`idAroma`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;
